...
<body>
    ...
    <table border="1" style="border-collapse: collapse;" width="100%">
        ...
        <tbody>
            <?php
            $no = 1;
            // Tambahkan kondisi WHERE untuk hanya mencetak pesanan yang baru dilakukan
            $data = mysqli_query($konektor, "SELECT pemesanan.*, lapangan.namalapangan, lapangan.hargasewa FROM pemesanan JOIN lapangan ON pemesanan.idlapangan = lapangan.idlapangan WHERE pemesanan.idpemesanan = (SELECT MAX(idpemesanan) FROM pemesanan)");
    ...
    <p class="mb-8 leading-relaxed">
        <center><strong>Terimakasih Atas Pesanan Anda</strong></center>
